            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('project.create') }}" class="btn btn-primary font-weight-bolder">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="product in products">
                                    ...
                                    <td>
                                        <a class="btn btn-info" :href="'{{ url('/project/edit/') }}'+'/'+product.id"><i class="far fa-edit"></i></a>
